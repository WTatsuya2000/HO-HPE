...
# (n, Nt)。N4LO は L_m(Nt, Nt+8) なので Nt=4 は n=12、Nt=6 は n=14 まで必要。
# (14,6) は最も重く（56395 クラス）数分かかる。
grid = [(4,4),(6,4),(8,4),(10,4),(12,4),(14,4),(6,6),(8,6),(10,6),(12,6),(14,6),(8,8),(10,8),(12,8),(10,10),(12,10),(12,12)]
for (n,Nt) in grid
    for m in 1:div(n,Nt)
